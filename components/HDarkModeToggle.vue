<template lang="pug">
  button.relative.flex.items-center.h-10.px-4.bg-gray-200.dark_bg-dark-surface.dark_text-dark-onSurfaceSecondary.rounded-full.text-light-onSurfacePrimary.dark_text-dark-onSurfacePrimary.focus_outline-none.transition-colors.duration-300.ease-linear(@click.prevent='setCurrentTheme')
