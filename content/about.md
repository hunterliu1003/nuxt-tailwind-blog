...
#### [**vue_randomize_svg_def_ids**](https://github.com/hunterliu1003/vue_randomize_svg_def_ids) 是一個 SVG 程式碼轉換工具，使用 Vue `vm._uid` 和 `hash` 產生隨機的字串，並用來替換向量圖在 html 元素中的 id，[Demo](https://hunterliu1003.github.io/vue_randomize_svg_def_ids/)。
